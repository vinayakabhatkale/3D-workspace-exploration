...
class Wandb:
    ...
    def launch(cfg, launch: bool):
        if launch:
            ...
            optimizer_class = getattr(cfg.training.optim.optimizer, "class")
            ...
            # own code
            Wandb._set_to_wandb_args(wandb_args, cfg, "base_lr")
            Wandb._set_to_wandb_args(wandb_args, cfg, "batch_size")
            ...
            wandb_args["config"] = {
                **config,
                "run_path": os.getcwd(),
                "base_lr": cfg.training.optim.base_lr,
                "optimizer": optimizer_class,
                "batch_size": cfg.training.batch_size,
                "num_points": cfg.data.number_points,
                "real_data": cfg.data.include_real_data_to_training,
                "sampling": cfg.data.sampling_strategy
            }
